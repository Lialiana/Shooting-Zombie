...
# 3 - Load images
player = pygame.image.load("lina folder/images/dude.png")
grass = pygame.image.load("lina folder/images/grass.png")
castle = pygame.image.load("lina folder/images/castle.png")
arrow = pygame.image.load("lina folder/images/bullet.png")
badguyimg1 = pygame.image.load("lina folder/images/badguy.png")
...
pygame.mixer.music.load('lina folder/sounds/jump.mp3') # bg music
...
while running:
    ...
    for badguy in badguys:
        ...
        if badrect.left<14: # badger hit castle
            hit.play() 
